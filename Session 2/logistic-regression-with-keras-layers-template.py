...
number_trainsamples = train_X.shape[0]
number_testsamples = test_X.shape[0]
...
x = Input(shape=(feature_dimension,), name="input_layer")
y = Dense(1, name="linear_layer", activation="sigmoid")(x)
