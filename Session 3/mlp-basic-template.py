...
for l in range(1, num_layers):
    weight_variable = (K.random_uniform_variable(shape=(num_units[l-1], num_units[l]),
                                            low=-1., high=1.,
                                            dtype='float32'),)
...
#Defining SoftMax Output Tensor
output_tensor = K.dot(input_tensor, weight_var_tupel[0]) + bias_var_tupel[0]
...
print("[MESSAGE] Model defined")
print("[MESSAGE] Starting Training")
